# pipeBlockMesh
This is a code to create a pipe geometry using blockMesh written based foam-extend-4.1.


## Installation
It is working on foam-extend-4.1.
```bash
git clone https://github.com/EhsanGLB/pipeBlockMesh.git
```


## Getting Started
```bash
cd pipeBlockMesh/case
blockMesh
simpleFoam
```
